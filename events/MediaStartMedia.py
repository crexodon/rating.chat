...
class MediaStartMedia(EventBase):
    def __init__(self, chat_id: int):
        ...
        super().__init__(chat_id=chat_id, prev_event_ids=["creation_sex","random_positive", "work_fried"],
                         event_id="media_start_media",
                         buttons=[{'text':'Ich mache das Radio an', 'next_event_id': 'restmusik', 'decision_id': None},
                                  {'text': 'Ich öffne Spotify', 'next_event_id': 'restmusik', 'decision_id': 'Spotify'},
                                  {'text': 'Hey, Alexa...', 'next_event_id': 'restmusik', 'decision_id': 'Amazon'},
