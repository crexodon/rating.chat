...
class Restmusik(EventBase):
    def __init__(self, chat_id: int):
        super().__init__(chat_id=chat_id, prev_event_ids=["media_start_media"],
                         event_id="restmusik" ,
                         buttons=[{'text': 'Per Whatsapp mit Manni teilen', 'next_event_id': 'start_date'},
                                  {'text': 'Ab auf facebook damit', 'next_event_id': 'start_date'},
                                  {'text': 'Ab zu youtube', 'next_event_id': 'start_date'}],
